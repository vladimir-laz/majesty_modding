...
- [[спавн-и-деньги-в-миссиях]] — ⭐ спавн логов кампании и стартовые деньги задаются в файле МИССИИ (.mi): `helper/spawn_program_collection` (task none/protect = гарнизон, attack_in_zone = волны) и `{"kingdoms"}` (деньги игрока = humanplayer 1). Миссия также решает, какие здания доступны.
